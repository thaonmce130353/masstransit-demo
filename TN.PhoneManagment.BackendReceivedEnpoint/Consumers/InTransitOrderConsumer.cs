...
{
    public class InTransitOrderConsumer : IConsumer<IInTransitOrder>
    {
        private readonly ILogger<SubmitOrderConsumer> _logger;
        private readonly MyDbContext _context;

        public InTransitOrderConsumer(ILogger<SubmitOrderConsumer> logger, MyDbContext context)
        {
            _logger = logger;
            _context = context;
        }

        public async Task Consume(ConsumeContext<IInTransitOrder> context)
        {
